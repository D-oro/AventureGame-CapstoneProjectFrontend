...
import monster1 from '../sounds/mnstr7.wav'
        ...
        <div className='room-container'>
            ...
            <main className='main'>
               { playerOne.healthPoints <= 0 ? <div className='player-box-alt'> {playerOne.name} is dead!</div>:<div className='player-box'>{playerOne.name}</div>}
                { NPCOne.healthPoints <= 0 ? <div className='enemy-box-alt-2'>{NPCOne.name} is dead!</div>: <div className='enemy-box-2'>{NPCOne.name}</div>}
            </main>
